...
`;function ct(e,t){return n=>n?e():t()}function ft(e){return ct(e,(()=>null))}function dt(e){return ft((()=>({opacity:0})))(e)}const pt=e=>{const{cascade:t=!1,damping:n=.5,delay:a=0,duration:o=1e3,fraction:l=0,keyframes:i=nt,triggerOnce:s=!1,className:u,style:c,childClassName:f,childStyle:d,children:p,onVisibilityChange:m}=e,h=(0,r.useMemo)((()=>function(e){let{duration:t=1e3,delay:n=0,timingFunction:r="ease",keyframes:a=nt,iterationCount:o=1}=e;return je`
  ...
  `}({keyframes:i,duration:o})),[o,i]);return void 0==p?null:"string"===typeof(y=p)||"number"===typeof y||"boolean"===typeof y?Me(ht,{...e,animationStyles:h,children:String(p)}):(0,Ke.isFragment)(p)?Me(yt,{...e,animationStyles:h}):Me(Re,{children:r.Children.map(p,((i,p)=>{if(!(0,r.isValidElement)(i))return null;const y=a+(t?p*o*n:0);switch(i.type){case"ol":case"ul":return Me($e,{children:t=>{let{cx:n}=t;return Me(i.type,{...i.props,className:n(u,i.props.className),style:Object.assign({},c,i.props.style),children:Me(pt,{...e,children:i.props.children})})}});case"li":return Me(qe,{threshold:l,triggerOnce:s,onChange:m,children:e=>{let{inView:t,ref:n}=e;return Me($e,{children:e=>{let{cx:r}=e;return Me(i.type,{...i.props,ref:n,className:r(f,i.props.className),css:ft((()=>h))(t),style:Object.assign({},d,i.props.style,dt(!t),{animationDelay:y+"ms"})})}})}});default:return Me(qe,{threshold:l,triggerOnce:s,onChange:m,children:e=>{let{inView:t,ref:n}=e;return Me("div",{ref:n,className:u,css:ft((()=>h))(t),style:Object.assign({},c,dt(!t),{animationDelay:y+"ms"}),children:Me($e,{children:e=>{let{cx:t}=e;return Me(i.type,{...i.props,className:t(f,i.props.className),style:Object.assign({},d,i.props.style)})}})})}})}}))});var y},mt={display:"inline-block",whiteSpace:"pre"},ht=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:a=0,duration:o=1e3,fraction:l=0,triggerOnce:i=!1,className:s,style:u,children:c,onVisibilityChange:f}=e,{ref:d,inView:p}=Xe({triggerOnce:i,threshold:l,onChange:f});return ct((()=>Me("div",{ref:d,className:s,style:Object.assign({},u,mt),children:c.split("").map(((e,n)=>Me("span",{css:ft((()=>t))(p),style:{animationDelay:a+n*o*r+"ms"},children:e},n)))})),(()=>Me(yt,{...e,children:c})))(n)},yt=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,className:a,style:o,children:l,onVisibilityChange:i}=e,{ref:s,inView:u}=Xe({triggerOnce:r,threshold:n,onChange:i});return Me("div",{ref:s,className:a,css:ft((()=>t))(u),style:Object.assign({},o,dt(!u)),children:l})};Ie`
  from,
  20%,
  40%,
  60%,
