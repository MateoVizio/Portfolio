    ...
    <div style={styles.homeContainer}>
      <section style={styles.heroSection}>
        <div style={styles.heroContent}>
          ...
          <img src={`${process.env.PUBLIC_URL}/cara.png`} style={styles.foto} alt="Descripción de la imagen" />
      ...
      <section id="contact" ref={contactoRef} style={styles.section}>
        ...
        <a href={`${process.env.PUBLIC_URL}/CvMateoVizio.pdf`} style={styles.downloadButton} download>
